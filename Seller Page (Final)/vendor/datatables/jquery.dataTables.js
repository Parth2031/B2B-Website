...
(function (factory) {
   ...
   *
   * SR-Additionally the API is designed to allow you to easily work with the data in
   ...
   * `pop`, `reverse` etc) as well as SR-Additional helper methods (`each`, `pluck`,
   ...
   * available when `ajax.url()` is used to set a URL. SR-Additionally, this method
   ...
   * @param {array} [...] Optional SR-Additional sorting conditions
   * @returns {DataTables.Api} this
   */
  ...
  DataTable.defaults = {
     ...
     * the following parameters provide SR-Additional options in DataTables or
  ...
  DataTable.ext = _ext = {
     ...
     *
     * Pagination types (the four built in options and any SR-Additional plug-in
  ...
  //
  // Note that SR-Additional search methods are added for the html numbers and
  ...
  // SR-Additional methods if a non-period decimal place is used.
  ...
  $.extend(true, DataTable.ext.renderer, {
    header: {
      _: function (settings, cell, column, classes) {
        // No SR-Additional mark-up required
